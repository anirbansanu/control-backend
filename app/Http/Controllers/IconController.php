...
class IconController extends Controller
{
    ...
    public function icons($query=null,$version=null)
    {
        $icons=new Icon;
        if($query != null)
            $icons = $icons->where('title', 'LIKE','%'.$query.'%');
        if($version != null)
        {
            $icons = $icons->where('version',$version);
        }
        $icons = $icons->get();
        return view("icons",compact('icons'));
    }

    public function iconlist($query=null,$version=null)
    {
        $icons=new Icon;
        if($query != null)
            $icons = $icons->where('title', 'LIKE','%'.$query.'%');
    ...
    public function test()
    {
        ...
        //     "fab fa-youtube"
        // ];
        // foreach($icons_list as $item){
        //     $icons[]=Icon::updateOrCreate(['title' => $item,'version' => 5],['title' => $item]);
        // }
