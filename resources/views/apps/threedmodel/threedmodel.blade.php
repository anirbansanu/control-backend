...
<html>
<head>
  <title>3d Human Animation</title>
  <!-- Include Three.js via CDN -->
  <script src="https://cdn.jsdelivr.net/npm/three@0.119.1/build/three.min.js"></script>
  <script src="https://raw.githubusercontent.com/boytchev/mannequin.js/main/mannequin.js"></script>
  <style>
  body{
   margin: 0;
   padding : 0;
  ...
  <script>
    ...
    */
    ...
    var woman = new Female();
        woman.position.set(-11,-16,0);
        woman.turn = 0;
        woman.r_leg.raise = 45;
        woman.l_leg.raise = 45;
        woman.r_knee.bend = 150;
        woman.l_knee.bend = 150;
    woman.torso.bend = 25;

    // woman.l_arm.raise = 45;
    // woman.l_elbow.bend = 120;

    // woman.r_arm.raise = 45;
    ...
    //man.r_leg.raise = 30;   
        ...
        function animate(t)
            ...
            //man.head.turn = 90*sin(2*t);
            //man.position.x = 30*sin(0.4*t);
            // man.turn = 30*sin(2*t)-90;
            
            let x = 5;
            
            //console.log(`t = ${x}    sin(t) = ${sin(x)}    cos(x) = ${cos(x)}`);
            
            //man.l_leg.raise = man.l_leg.raise  + .2;//(40*sin(2*t)+60);
            
            //range  speed  middlePosition
            //(40*sin(3*t)+90)        
            //man.l_leg.raise = (10*sin(3*t)+90);
                    //man.l_knee.bend = (90*cos(3*t)+45);
                    // man.r_leg.raise= (40*cos(4*t)+60);
                    // man.r_knee.bend = (-40*sin(8*t)+60);
                    // man.l_arm.raise = (50*sin(2.1*t)+40);
                    // man.l_arm.straddle = (10*sin(t)+40);
                    // man.l_elbow.bend = (-20*sin(t)+40);
                    // man.r_arm.raise = (50*cos(2.5*t)+40);
                    // man.r_arm.straddle = (10*sin(t)+40);
                    // man.r_elbow.bend = (-20*sin(t)+40);
            
            
    //         woman.l_arm.raise(50*sin(2.1*t)+40);
    //         woman.l_arm.straddle(10*sin(t)+40);
    //         woman.l_elbow.bend(-20*sin(t)+40);
            //woman.head.nod(45*sin(t));
            woman.head.nod = 20 * sin(2.5 * t) + -20;
